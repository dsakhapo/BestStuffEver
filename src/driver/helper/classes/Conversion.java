...
public class Conversion 
{
	...
	public int[] stringToBitseq(String userId)		
	{
		int[] binaryArray = new int[userId.length() * 6];
		int i = 0;

		for (int oneCharCounter = 0; oneCharCounter < userId.length(); oneCharCounter++) 
		{
			int customizedAsciiValue = getCustomizedAsciiValue(userId.charAt(oneCharCounter));	//Will convert each character to a customized Ascii value and store it
